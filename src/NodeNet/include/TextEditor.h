...
public:
    ...
    struct LanguageDefinition
    {
        ...
        static const LanguageDefinition& NodeScript();
...
void TextEditor::Render()
{
    ...
    if (!mLines.empty())
    {
        ...
        if (ImGui::IsMousePosValid() && false)
        {
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::NodeScript()
{
    static bool inited = false;
    static LanguageDefinition langDef;
    if (!inited)
