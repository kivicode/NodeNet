...
void ImGui::ShowUserGuide()
{
    ...
    ImGui::BulletText("You can apply arithmetic operators +,*,/ on numerical inputs.\nUse +- to subtract.");
    ImGui::Unindent();
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::SameLine(); HelpMarker("You can apply arithmetic operators +,*,/ on numerical inputs.\n  e.g. [ 100 ], input \'*2\', result becomes [ 200 ]\nUse +- to subtract.\n");
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            // Note that characters inputs are preserved even by InputText() if the font cannot be displayed, so you can safely copy & paste garbled characters into another application.
    ...
    if (ImGui::TreeNode("Combo"))
    {
        ...
        // Simplified one-liner Combo() API, using inputs packed in a single constant string
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // Create a dummy array of contiguous float inputs to plot
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::DragFloat4("Raw HSV inputs", (float*)&color_stored_as_hsv, 0.01f, 0.0f, 1.0f);
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::Text("Drags:");
        ImGui::Checkbox("Clamp integers to 0..50", &drag_clamp); ImGui::SameLine(); HelpMarker("As with every widgets in dear imgui, we never modify inputs unless there is a user interaction.\nYou can override the clamping limits by using CTRL+Click to input a value.");
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Groups"))
    {
        ...
        ImGui::PlotHistogram("##inputs", values, IM_ARRAYSIZE(values), 0, NULL, 0.0f, 1.0f, size);
