...
enum ImGuiItemFlags_
{
    ...
    ImGuiItemFlags_MixedValue               = 1 << 6,  // false    // [BETA] Represent a mixed/indeterminate value, generally multi-selection where inputs differ. Currently only supported by Checkbox() (later should support all sorts of widgets)
...
// ImDrawList: You may set this to higher inputs (e.g. 2 or 3) to increase tessellation of fast rounded corners path.
